...
| Doc | Summary | Status | Updated |
|---|---|---|---|
| `research/competitive-landscape.md` | Ecard incumbents, custom-song vendors, one free direct competitor, pricing implications | Draft | 2026-09-20 |
...
| Doc | Summary | Status | Updated |
|---|---|---|---|
| `tasks/README.md` | How to query the 526 tasks without loading them all | Draft | 2026-09-20 |
